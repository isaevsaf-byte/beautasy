        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-full max-w-md bg-[#FDFBF7] z-50 shadow-2xl flex flex-col"
            >
              {/* Header */}
              ...
              {/* Footer */}
              {items.length > 0 && (
                <div className="border-t border-lavender-soft/40 px-6 py-5 space-y-4">
                  {/* Total */}
